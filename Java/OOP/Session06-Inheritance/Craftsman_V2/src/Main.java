...
//        }
    ...
    public static void playWithSquare() {
        ...
        // VUÔNG LÀ VUÔNG, CÒN LÀ HÌNH CHỮ NHẬT THÌ TỰ NGẦM HIỂU
        s1.paint();

        // Vi diệu tập 1
        Rectangle r1 = new Rectangle("MÁ", "PINK", 7.0, 8.0);
        // HÌNH CHỮ NHẬT LÀ HÌNH CHỮ NHẬT, Chuẩn cơm mẹ nấu
        r1.paint();

        // Vi diệu tập 2
        Rectangle s2 = new Square("BÉ NA", "RAINBOW", 10.0);
        // ĐỌC LÀ VUÔNG LÀ HÌNH CHỮ NHẬT, hù theo kế thừa DÒNG HỌ RECTANGLE
        s2.paint(); // CON QUA MẶT CHA, ĐA HÌNH XUẤT HIỆN Ở ĐÂY NÈ
        // HÀM PAINT() CỦA CHA, XEM LÚC CHẠY COI!!!!!
    }
}
